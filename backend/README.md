...
## Project Structure
    ...
    ├── testapplicationuse_123633  # Django project configurations
...
1. Clone this repo and `cd testapplicationuse_123633`
...
2. Clone this repo and `cd testapplicationuse_123633`
